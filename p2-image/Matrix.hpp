...
/* Matrix.hpp Originally written by James Juett at the University of Michigan
 * for the image processing project in EECS 280, Winter 2016.
 *
 * The Matrix module is based on an earlier project by Andrew DeOrio.
 */

#include <iostream>
#include <vector>

// Representation of a 2D matrix of integers Matrix objects may be copied.
struct Matrix
{
  int width;
  int height;
